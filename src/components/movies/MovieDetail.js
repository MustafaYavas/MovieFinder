                ...
                <div className={`${styles['bg-img']} ${styles['bg-margin']}`} style={{backgroundImage: `linear-gradient(to bottom, rgba(17,17,17, .1), rgba(17,17,17, 1)), url(https://image.tmdb.org/t/p/original/${movie.backdrop_path || movie.poster})`}}>
                    ...
                    <div className='container'>
                        <div className='row ps-5'>
                            ...
                            <div className={`col-12 col-md-8 col-lg-9 text-light ${styles['row-margin-content']}  ${styles['row-margin-content-md']}`}>
                                    ...
                                    >
                                        {
                                            cast.map((item, index) => (
                                                <SwiperSlide key={index}>
                                                    <div className={`card me-2 ${styles['cast-card']}`}>
                                                        <img className={`${styles['cast-img-size']} rounded  me-sm-5 me-xl-0`} src={`https://image.tmdb.org/t/p/w500/${item.profile_path}`} alt='cast-img'/>
                                                        <p>{item.name}</p>
                                                    </div>
                                                </SwiperSlide>
                                            ))
